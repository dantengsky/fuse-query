...
#[test]
fn test_decode_v177_task_delete_task_id() -> anyhow::Result<()> {
    let task_message_delete_v177 = vec![
        42, 29, 10, 6, 116, 97, 115, 107, 95, 99, 18, 17, 10, 11, 119, 97, 114, 101, 104, 111, 117,
        115, 101, 95, 97, 18, 2, 49, 48, 24, 11, 160, 6, 177, 1, 168, 6, 24,
    ];
    ...
    common::test_load_old(func_name!(), task_message_delete_v177.as_slice(), 177, want)?;
