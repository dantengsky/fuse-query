...
pub fn get_statistics_desc() -> Arc<BTreeMap<ProfileStatisticsName, ProfileDesc>> {
    PROFILES_DESC.get_or_init(|| {
        Arc::new(BTreeMap::from([
            ...
            (ProfileStatisticsName::ExchangeBlockToArrowTime, ProfileDesc {
                display_name: "exchange block-to-arrow time",
                desc: "Time spent converting exchange DataBlocks to Arrow RecordBatches",
                index: ProfileStatisticsName::ExchangeBlockToArrowTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::ExchangeIpcEncodeTime, ProfileDesc {
                display_name: "exchange IPC encode time",
                desc: "Time spent encoding Arrow schemas and RecordBatches as IPC",
                index: ProfileStatisticsName::ExchangeIpcEncodeTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::ExchangeLz4CompressTime, ProfileDesc {
                display_name: "exchange LZ4 compress time",
                desc: "Time spent applying the native Flight IPC LZ4 compression path",
                index: ProfileStatisticsName::ExchangeLz4CompressTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
            (ProfileStatisticsName::ExchangeIpcDecodeTime, ProfileDesc {
            ...
            (ProfileStatisticsName::ExchangeArrowToBlockTime, ProfileDesc {
                display_name: "exchange arrow-to-block time",
                desc: "Time spent converting decoded Arrow RecordBatches to DataBlocks",
                index: ProfileStatisticsName::ExchangeArrowToBlockTime as usize,
                unit: StatisticsUnit::NanoSeconds,
                plain_statistics: false,
            }),
